    ...
    function renderPage(slug) {
      ...
      var inlineRenderers = {
        ...
        'space-stack': function() {
          var wrap = document.createElement('div');
          wrap.style.cssText = 'display:inline-flex;flex-direction:column;width:48px;';
      ...
      bodyEl.querySelectorAll('[data-ex]').forEach(function(el) {
        ...
        if (td && td.tagName === 'TD') {
          td.style.cssText += 'display:flex;flex-direction:column;align-items:flex-start;gap:6px;';
