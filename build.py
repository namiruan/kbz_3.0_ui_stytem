...
__SEGMENT_CSS__
  ...
  /* Organism Anatomy 전용 — an-box(레이어 outline) + an-label(레이어 이름) */
  .an-box { position: relative; outline: 1px dashed var(--color-border-subtle); border-radius: var(--radius-sm); padding-top: var(--space-20); }
