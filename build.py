...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* ─── 섀도우 스케일 ─── */
  .shadow-wrap { margin: var(--space-8) 0 var(--space-24); background: var(--color-surface-subtle); border-radius: var(--radius-lg); padding: var(--space-20); display: flex; flex-direction: column; gap: 6px; }
  .shadow-grid-row { display: grid; grid-template-columns: 52px repeat(4, 1fr); gap: var(--space-12); align-items: center; }
  .shadow-row-label { font-family: var(--font-family-mono); font-size: 10px; color: var(--color-text-subtle); text-align: right; padding-right: var(--space-8); white-space: nowrap; }
  ...
  .shadow-cell-empty { font-family: var(--font-family-mono); font-size: 10px; color: var(--color-text-disabled); text-align: center; }
