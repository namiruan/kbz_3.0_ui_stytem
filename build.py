        ...
        if (type === 'icon') {
          ...
          function makePair(d) {
            ...
            [1.5, 3].forEach(function(sw) {
              ...
              gridG.setAttribute('stroke', gridColor); gridG.setAttribute('stroke-width', '0.5'); gridG.setAttribute('opacity', '0.7');
              [4, 8, 12, 16, 20].forEach(function(v) {
                var vl = document.createElementNS(ns, 'line');
                vl.setAttribute('x1', String(v)); vl.setAttribute('y1', '0'); vl.setAttribute('x2', String(v)); vl.setAttribute('y2', '24');
                var hl = document.createElementNS(ns, 'line');
                hl.setAttribute('x1', '0'); hl.setAttribute('y1', String(v)); hl.setAttribute('x2', '24'); hl.setAttribute('y2', String(v));
                gridG.appendChild(vl); gridG.appendChild(hl);
              });
              ...
              ln1.setAttribute('x1', '12'); ln1.setAttribute('y1', '7'); ln1.setAttribute('x2', '12'); ln1.setAttribute('y2', '17');
              var ln2 = document.createElementNS(ns, 'line');
              ln2.setAttribute('x1', '7'); ln2.setAttribute('y1', '12'); ln2.setAttribute('x2', '17'); ln2.setAttribute('y2', '12');
          ...
          wrap.appendChild(makeRow('토큰', makeCell(function(d){ return iSemanticMap[d.key] || d.key; }, 'icon-cell--token')));
