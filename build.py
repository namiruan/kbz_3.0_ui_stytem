...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .component-code-item { display: flex; align-items: flex-start; gap: var(--space-8); padding: var(--space-8); border-bottom: 1px solid rgba(255,255,255,0.06); }
  .component-code-item:last-child { border-bottom: none; }
  .component-code-labels { display: flex; flex-direction: column; gap: var(--space-4); flex-shrink: 0; width: 56px; }
