...
__SEGMENT_CSS__
  ...
  /* 패턴 탐색기가 있는 preview — 박스 제거, 트리 sticky 가능하도록 */
  .component-preview-stage:has(.pattern-explorer) { background: transparent; padding: var(--space-16) 0 0; display: block; gap: 0; min-height: 0; }
