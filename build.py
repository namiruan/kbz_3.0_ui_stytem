...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .height-col { display: flex; flex-direction: column; align-items: center; cursor: default; transition: transform var(--duration-fast) ease; }
      ...
      bodyEl.querySelectorAll('.scale-placeholder').forEach(function(el) {
        ...
        if (type === 'height') {
          ...
          entries.forEach(function(e) {
            ...
            lineTop.className = 'height-arrow-line';
            ...
            arrow.appendChild(lineTop);
            arrow.appendChild(arrowBot);

            bar.appendChild(arrow);
            bar.appendChild(arrowVal);
            col.appendChild(bar);
