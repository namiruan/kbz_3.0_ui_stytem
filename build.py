...
__SEGMENT_CSS__
  ...
  .pattern-explorer__tree { width: 148px; flex-shrink: 0; display: flex; flex-direction: column; }
  ...
  .pattern-explorer__item { display: block; width: 100%; text-align: left; font-size: var(--font-size-sm); color: var(--color-text-default); background: none; border: none; padding: var(--space-4) var(--space-8) var(--space-4) var(--space-16); border-radius: var(--radius-sm); cursor: pointer; line-height: var(--line-height-ui); }
  ...
  [data-region] { position: relative; border-radius: var(--radius-sm); }
  [data-region].region-active { outline: 2px solid var(--color-blue-400); }
  [data-region].region-active::before { content: attr(data-region-label); position: absolute; top: 4px; right: 6px; font-size: 10px; line-height: 1; color: var(--color-blue-500); white-space: nowrap; pointer-events: none; font-weight: 600; }
  [data-region].region-active [data-region] { outline: none; }
  [data-region].region-active [data-region]::before { display: none; }
  ...
  .an-box .an-box .an-box { outline: 1px solid var(--color-blue-100); }
  .an-box .an-box .an-box .an-box { outline: 1px dashed var(--color-border-subtle); }
  .an-label { position: absolute; top: var(--space-4); left: var(--space-6); font-size: 10px; line-height: 1; color: var(--color-text-subtle); white-space: nowrap; pointer-events: none; }
