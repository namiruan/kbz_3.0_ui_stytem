...
| `text · 브랜드` | 브랜드·액센트 컬러 | `--color-text-brand`, `--color-text-brand-strong`, `--color-text-accent`, `--color-text-accent-strong` |
| `text · 상태` | 상태 피드백 | `--color-text-caution`, `--color-text-caution-subtle`, `--color-text-error` |
