...
> typography는 예외 — Text Style은 `--text-[역할]-[크기]-[속성]` 4단계 (font-size·line-height·letter-spacing·font-weight 합성).
...
| font-size | --font-size-[px값]<br>`--font-size-11`<br>`--font-size-14` | Text Style을 통해 참조 |
| font-weight | --font-weight-[weight명]<br>`--font-weight-semibold` | Text Style을 통해 참조 |
| line-height | --line-height-[밀도]<br>`--line-height-tight`<br>`--line-height-base`<br>`--line-height-relaxed` | Text Style을 통해 참조 |
| letter-spacing | --letter-spacing-[크기]<br>`--letter-spacing-tight`<br>`--letter-spacing-normal`<br>`--letter-spacing-wide` | Text Style을 통해 참조 |
| font-family | — | --font-family-[유형]<br>`--font-family-base` |
| text style | — | --text-[역할]-[크기]-[속성]<br>`--text-body-md-font-size`<br>`--text-heading-md-line-height`<br>`--text-label-xs-font-weight` |
