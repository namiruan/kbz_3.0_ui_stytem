...
<div class="anatomy-row">
  ...
  <span data-component class="tag tag--md tag--readonly">미선택</span>
  <span data-component class="tag tag--selected tag--md tag--readonly">선택됨</span>
  <span data-component class="tag tag--pill tag--readonly" style="margin-inline-start: var(--space-16);">미선택</span>
  <span data-component class="tag tag--selected tag--pill tag--readonly">선택됨</span>
  <span data-component class="tag tag--pill tag--md tag--readonly">미선택</span>
  <span data-component class="tag tag--selected tag--pill tag--md tag--readonly">선택됨</span>
</div>
<div class="anatomy-row">
