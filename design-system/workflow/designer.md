...
| 사용자 요청 패턴 | 실행할 흐름 |
|---|---|
| 컴포넌트 만들어줘 / 추가해줘 | 새 컴포넌트 만들기 |
| 토큰 추가해줘 / 토큰 새로 만들어줘 | 새 토큰 추가 |
| 토큰 바꿔줘 / 토큰 수정해줘 / 토큰 변경해줘 | 기존 토큰 변경 |
| 토큰 삭제해줘 / 토큰 제거해줘 | 토큰 제거 |
| 컴포넌트 수정해줘 / 컴포넌트 바꿔줘 | 기존 컴포넌트 수정 |
| 컴포넌트 deprecated / 컴포넌트 사용 중단 | 컴포넌트 Deprecated 처리 |
| 컴포넌트 삭제해줘 / 컴포넌트 제거해줘 | 컴포넌트 제거 |
| 컴포넌트 검토해줘 / 이 코드 맞아? | 컴포넌트 검토 |
| 전체 점검해줘 / 일관성 검토해줘 | 전체 일관성 감사 |
